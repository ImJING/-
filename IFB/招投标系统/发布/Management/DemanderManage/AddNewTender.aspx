<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddNewTender.aspx.cs" Inherits="JSMSTC.InviteTender.Management.DemanderManage.AddNewTender"
    ...
    <div style="padding-left: 50px; padding-top: 25px;">
        <table>
            ...
            <tr>
                ...
                <td>
                    <span style="color: Red;">*</span>
                    <asp:TextBox ID="TextBoxPrice" TabIndex="6" MaxLength="20"
                        runat="server" SkinID="TextBox" Width="300px"></asp:TextBox>￥
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="TextBoxPrice"
                        ErrorMessage="预算价格不能为空!" SetFocusOnError="True" Display="None">*</asp:RequiredFieldValidator>
            ...
            <tr>
                ...
                <td>
                    ...
                    &nbsp;<asp:LinkButton ID="LinkButtonUpload" runat="server" CausesValidation="False"
                        ...
                        ToolTip="没有文件，点击上传文件" Visible="False" Text="<img src='../images/IsNotActive.gif' border='0' />"></asp:LinkButton>
            ...
            <tr>
                <td colspan="2" align="center">
                    <table>
                        <tr>
                            <td>
                                <asp:Button ID="ButtonSubmit" Text="保    存" SkinID="Button" runat="server" Width="100px" />
                            </td>
                            <td>
                                <asp:CheckBox ID="IsOk" runat="server" Checked="false" ForeColor="#00CCFF" Text="立即提交审核" />
                            </td>
                            <td>
                                <span style="font-size: 12px; color: Gray;">勾选后将立即提交审核</span>
