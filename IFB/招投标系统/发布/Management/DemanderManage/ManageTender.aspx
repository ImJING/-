<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageTender.aspx.cs" Inherits="JSMSTC.InviteTender.Management.DemanderManage.ManageTender"
                ...
                <tr style="height: 50px;">
                    <td>
                        <asp:Image ID="Image2" runat="server" ImageUrl="~/images/loginin_icon_1.gif" Width="13"
                            Height="13" />
                        &nbsp;&nbsp;<span style="font-size: 14px; font-weight: bolder;">项目需求列表</span>
                    </td>
                </tr>
                <tr>
                    <td>
                        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                            ...
                            <tr>
                                <td class="lab_title">
                                    <asp:Label ID="Label2" runat="server" Text="审核状态:"></asp:Label>
                                </td>
                                <td>
                        ...
                        <asp:GridView ID="GridView1" runat="server" SkinID="GridView" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="报名开始日期">
                                    <ItemTemplate>
                                        <asp:Label ID="LabelBeganDate" runat="server" Text='<%# GetDateStr(Eval("BeginDate")) %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle Width="100px" HorizontalAlign="Center" VerticalAlign="Middle" Wrap="False" />
                                ...
                                <asp:TemplateField HeaderText="报名截止日期">
                                    <ItemTemplate>
                                        <asp:Label ID="LabelEndDate" runat="server" Text='<%# GetDateStr(Eval("EndDate")) %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle Width="100px" HorizontalAlign="Center" VerticalAlign="Middle" Wrap="False" />
                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="审核状态">
                                    <ItemTemplate>
                                        <asp:Label ID="LabelVerifyState" runat="server"><%# Eval("Displaysatat")%></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="项目状态">
                                    <ItemTemplate>
                                        <asp:Label ID="LabelTenderState" runat="server" Text='<%# (int)Eval("State")==0?"已结束":"进行中" %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle Width="100px" HorizontalAlign="Center" VerticalAlign="Middle" />
                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="中标企业">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="HyperLinkWinner" runat="server" Enabled="false">没有中标企业</asp:HyperLink>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="操    作">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ImageButtonIsShow" runat="server" ToolTip="提交审核" CommandArgument='<%# Eval("Id") %>'
                                            CommandName="IsShow" ImageUrl="~/Management/images/IsShow.gif" OnClientClick="return confirm('确定提交审核吗?');" />
                                        <asp:ImageButton ID="ImageButtonPro" Height="16px" Width="16px" runat="server" CommandArgument='<%# Eval("Id") %>'
                                            ImageUrl="~/Management/images/loginin_icon_2.gif" ToolTip="对中标企业进行评价" />
                                        <asp:ImageButton ID="ImageButtonCheck" Visible="false" Height="16px" Width="16px" runat="server" CommandName="Check" CommandArgument='<%# Eval("Id") %>'
                                            ImageUrl="~/images/notepad.gif" ToolTip="查看评价" />
                                        <asp:ImageButton ID="ImageButtonEditPro" runat="server" ToolTip="编辑公告" CommandArgument='<%# Eval("Id") %>'
                                            CommandName="EditPro" ImageUrl="~/Management/images/edit.gif" />
                                        <asp:ImageButton ID="ImageButtonDeletePro" runat="server" CommandArgument='<%# Eval("Id") %>'
                                            CommandName="DeletePro" ImageUrl="~/Management/images/delete.gif" OnClientClick="return confirm('确定要删除吗?');"
                                            ToolTip="删除" />
                                    </ItemTemplate>
