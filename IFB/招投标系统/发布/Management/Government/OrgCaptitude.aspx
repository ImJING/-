<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrgCaptitude.aspx.cs" Inherits="JSMSTC.InviteTender.Management.Government.OrgCaptitude" StylesheetTheme="HAM1.0" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>淮安市清河区小型工程招标网 -经理人资质管理</title>
            ...
            <tr style="height: 50px;">
                <td>
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/images/loginin_icon_1.gif" Width="13"
                        Height="13" />
                    &nbsp;&nbsp;<span style="font-size: 14px; font-weight: bolder;">经理人资质管理</span>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" SkinID="GridView"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="资质类型" SortExpression="Name">
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="资质描述" SortExpression="Statement">
                                <EditItemTemplate>
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label3" runat="server" Text='<%# Bind("Statement") %>'></asp:Label>
                                </ItemTemplate>
