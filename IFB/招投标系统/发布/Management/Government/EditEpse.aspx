<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditEpse.aspx.cs" Inherits="JSMSTC.InviteTender.Management.Government.EditEpse"
...
<head id="Head1" runat="server">
    <title>淮安市清河区小型工程招标网 -企业信息管理</title>
    <style type="text/css">
        .tdtitle
        {
            padding-left: 20px;
    ...
    <div style="padding-left: 45px; width: 1024px;">
        ...
        <table style="width: 100%; margin-top: 5px;">
            <tr style="height: 50px;">
                <td>
                    <asp:Image ID="Image2" runat="server" ImageUrl="~/images/loginin_icon_1.gif" Width="13px"
                        Height="13" />
                    &nbsp;&nbsp;<span style="font-size: 14px; font-weight: bolder;"><asp:Label ID="labelName"
            ...
            <tr>
                <td>
                    <div style="width: 100%; text-align: center;">
                        <asp:Wizard ID="WizardEpse" runat="server" ActiveStepIndex="0" Width="100%" DisplaySideBar="False"
                            DisplayCancelButton="True" OnFinishButtonClick="WizardEpse_FinishButtonClick"
                            OnCancelButtonClick="WizardEpse_CancelButtonClick" 
                            onnextbuttonclick="WizardEpse_NextButtonClick" 
                            onpreviousbuttonclick="WizardEpse_PreviousButtonClick">
                            <CancelButtonStyle BackColor="White" Width="60" BorderColor="#99ACDD" />
                            <NavigationButtonStyle BackColor="White" Width="60" BorderColor="#99ACDD" />
                            <StartNavigationTemplate>
                                <asp:Button ID="StartNextButton" runat="server" BackColor="White" BorderColor="#99ACDD"
                                    CommandName="MoveNext" Text="下一步" Width="60px" />
                                <asp:Button ID="CancelButton" runat="server" BackColor="White" BorderColor="#99ACDD"
                                    CausesValidation="False" CommandName="Cancel" Text="取消" Width="60px" />
                            </StartNavigationTemplate>
                            <WizardSteps>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="用户名不能为空!"
                                                    ControlToValidate="txt_loginname" Display="None" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                                            </td>
                                            <td class="tdlabel">
                                                法&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;人:
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="企业名称不能为空!"
                                                    ControlToValidate="txt_username" SetFocusOnError="True" Display="None">*</asp:RequiredFieldValidator>
                                            </td>
                                            <td class="tdlabel">
                                                企 业 性 质:
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txt_phone"
                                                    ErrorMessage="您输入的号码不合法!" ValidationExpression="((\d{11})&nbsp;^((\d{7,8})&nbsp;(\d{4}&nbsp;\d{3})-(\d{7,8})&nbsp;(\d{4}&nbsp;\d{3})-(\d{7,8})-(\d{4}&nbsp;\d{3}&nbsp;\d{2}&nbsp;\d{1})&nbsp;(\d{7,8})-(\d{4}&nbsp;\d{3}&nbsp;\d{2}&nbsp;\d{1}))$)"
                                            ...
                                            <td align="left">
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txt_email"
                                                    Display="None" ErrorMessage="您输入的邮箱不合法!" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
                                                ...
                                                <asp:GridView ID="GridViewCT" runat="server" DataKeyNames="Id" SkinID="GridView"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="操作">
                                                            ...
                                                            <FooterTemplate>
                                                                <asp:LinkButton ID="LinkButton5" runat="server" CommandName="Add" Text="新增企业资质"
                                                                     CausesValidation="False" />
                                                            </FooterTemplate>
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="LinkButton2" runat="server" CommandName="Edit" Text="编辑"
                                                                     CausesValidation="False" />
                                            ...
                                            <td valign="top">
                                                <asp:GridView ID="GridView2" runat="server" DataKeyNames="Id" SkinID="GridView" BackColor="White"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="操作">
                                                            <EditItemTemplate>
                                                                <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Update" Text="更新"
                                                                    Width="16px" CommandArgument='<%# Eval("Id") %>' CausesValidation="False" />
                                                                &nbsp;<asp:LinkButton ID="LinkButton4" runat="server" CommandName="Cancel" Text="取消"
                                                                    CausesValidation="False" />
                                                            </EditItemTemplate>
                                                            <FooterTemplate>
                                                                <asp:LinkButton ID="LinkButton5" runat="server" CommandName="Add" Text="新增项目经理"
                                                                     CausesValidation="False" />
                                                            </FooterTemplate>
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="LinkButton2" runat="server" CommandName="Edit" Text="编辑"
                                                        ...
                                                        <asp:TemplateField HeaderText="操作">
                                                            <EditItemTemplate>
                                                                ...
                                                                &nbsp;<asp:LinkButton ID="LinkButton4" runat="server" CommandName="Cancel" EnableTheming="False"
                                                                    EnableViewState="False" Text="取消"
                                                                    CausesValidation="false" />
                                                            </EditItemTemplate>
                                                            <FooterTemplate>
                                                                <asp:LinkButton ID="LinkButton5" runat="server" CommandName="Add" Text="新增设备"
                                                                   CausesValidation="false" />
                                                            </FooterTemplate>
                                                            <ItemTemplate>
                                                                ...
                                                                &nbsp;<asp:LinkButton ID="LinkButton2" runat="server" CommandArgument='<%# Eval("Id") %>'
                                                                    ...
                                                                    OnClientClick="return confirm('确定要删除吗?');" CausesValidation="false" />
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="100px" Wrap="False" />
                                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="100px" Wrap="False" />
                                                        </asp:TemplateField>
            ...
            <tr style="display: none;">
                <td>
                    <%--<asp:Button ID="ButtonShowImage" OnClick="ButtonShowImage_Click" runat="server" Text="Button" />--%>
                </td>
            </tr>
        </table>
    </div>
