<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComplaintList.aspx.cs"
    Inherits="JSMSTC.InviteTender.Management.Enterprise.ComplaintList" StylesheetTheme="HAM1.0" %>
...
<body>
    ...
    <div style="width: 800px; margin-left: 40px; margin-top: 5px;">
        <table style="width: 100%;">
            <tr style="height: 50px;">
                <td>
                    <asp:Image ID="Image2" runat="server" ImageUrl="~/images/loginin_icon_1.gif" Width="13"
                        Height="13" />
                    &nbsp;&nbsp;<span style="font-size: 14px; font-weight: bolder;">投诉建议列表</span>
                </td>
            </tr>
            <tr>
                <td>
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="ButtonSearch" runat="server" SkinID="Button" Width="70px" Text="查&nbsp;&nbsp;询"
                                    OnClick="ButtonSearch_Click" />
                                &nbsp;&nbsp;&nbsp;
                                <asp:Button ID="ButtonAdd" runat="server" SkinID="Button" Width="70px" Text="投&nbsp;&nbsp;诉"
                    ...
                    <asp:GridView ID="GridView1" SkinID="GridView" Width="100%" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="针对项目">
                                <ItemTemplate>
                                  <%--  <asp:HyperLink ID="LinkProTitle" CssClass="linka"  onclick='<%# String.Format("Populayer({0});",Eval("Id"))%>'  runat="server" Text='<%# Eval("Project.Title") %>'
                                        Target="_blank"></asp:HyperLink>--%>
                                       <a href="#" onclick='window.open("../ProjectDetails.aspx?proid=<%# Eval("Id")%>","","width=800,height=450,top=150,left=300, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no, status=no")'>
                                <%# Eval("Title") %></a>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="200px" />
                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="200px" />
                            ...
                            <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ImageButtonDel" runat="server" CommandArgument='<%# Eval("Id") %>'
                                        CommandName="de" ImageUrl="~/Management/images/delete.gif" OnClientClick="return confirm('确认撤销本条投诉？')"
                                        ToolTip="撤销投诉或意见" />
                                    <asp:ImageButton ID="ImageButton2" runat="server" CommandArgument='<%# Eval("Id") %>'
                                        CommandName="sc" ImageUrl="~/Management/images/arrow_!.gif" ToolTip="评价处理结果" />
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="80px" />
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="80px" />
                            </asp:TemplateField>
